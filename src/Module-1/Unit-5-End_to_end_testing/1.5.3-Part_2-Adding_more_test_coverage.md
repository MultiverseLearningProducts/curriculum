...
Part 3: you may have noticed we have no product details tests. The last part of this challenge is to add test coverage for these pages. Before you start, consider what you will test first and how you might test those elements.
