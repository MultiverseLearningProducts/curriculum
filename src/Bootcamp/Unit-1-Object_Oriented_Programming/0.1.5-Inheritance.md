...
## Assignment
* Rename the `Passenger` class to `Person`
* Create a `Passenger` class by extending the `Person` class. Think about the properties a passenger may have.
...
* When `board` is called on an instance of a plane, you should put crew and passengers in the correct property in the plane instance.
* All your refactoring should have tests that cover it
* Commit all your code and share the link with your coach for review.
...
Add a screenshot of your coverage report into Github. 
