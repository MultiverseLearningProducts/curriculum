...
A lifecycle method is a group of events that fire at predicatable times during the create of a Vue component. In our case, the `mounted` method can be used to request data once the component has been mounted (added) to the DOM.
