...
Large websites with 100s if not thousands of lines of CSS will _always_ use external files. This is because these files can be minified and then cached by the browser. If you're just testing or have a very small amount of CSS, then it's perfectly acceptable to use the inline technique.
