...
## Pre-requisites
Familiarity with [Database access using Node](/curriculum/Bootcamp/Unit-2-Databases/0.3.5-Database_access_using_Node.html) including the instructions described there for installing SQLite.
