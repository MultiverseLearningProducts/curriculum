...
## Lesson
![Hashing presentation slides](https://docs.google.com/presentation/d/1rol2aj8sEfGUrvCKCW4VovpZH56_D7-sbDJ7b9gzbIU/embed)
...
Can you create a password cracker to brute force guess simple passwords from MD1 or SHA hashes? Note that you should <emp>never</emp> try this out in the real world, this is an exercise just to demonstrate the importance of using string passwords and secure hashing algorithms!