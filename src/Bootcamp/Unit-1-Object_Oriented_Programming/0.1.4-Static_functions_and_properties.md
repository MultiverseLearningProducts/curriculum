...
### Static properties
The `static` keyword defines a static function or property for a class. Static functions and static properties cannot be called on instances of the class, instead, they're called on the class itself. An example of a static function is the JavaScript `Math.max(N)` method.
