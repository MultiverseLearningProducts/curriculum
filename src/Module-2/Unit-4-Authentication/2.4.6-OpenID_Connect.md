...
* login to Auth0
* logout from Auth0
* call your secure airport APIs and display the results in a web page. [This documentation](https://github.com/auth0/express-openid-connect/blob/master/EXAMPLES.md#4-obtaining-access-tokens-to-call-external-apis) will help you obtain the necessary token.
