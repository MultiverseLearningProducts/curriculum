...
* Use the boilerplate code above to fetch restaurant data from your API server and then write the code to add each restaurant, it's list of menus, and each menu's items into the DOM.

### top tips

Try to keep your code readable:

1. Write well named functions that do one thing
1. Compose your functions together to create the functionality you need
1. Style your restaurant data with CSS
