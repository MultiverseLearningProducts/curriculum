...
## Assignment
  ...
  1. Rewrite your `populateDb.js` script from before such that the [restaurant JSON data](https://raw.githubusercontent.com/MultiverseLearningProducts/restaurant-data/master/restaurants.json) is saved to a database using Sequelize
