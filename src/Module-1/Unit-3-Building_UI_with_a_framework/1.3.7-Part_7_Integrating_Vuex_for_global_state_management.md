...
This is quirky construct that is a function that returns and function that returns the results of the find method. Quirky or not, it's what we need to do in order for the state to be passed in and for us to be able pass in the productId.
