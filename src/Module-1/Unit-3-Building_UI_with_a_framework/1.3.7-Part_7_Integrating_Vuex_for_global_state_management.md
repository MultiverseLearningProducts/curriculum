...
The `state` parameter here is somewhat abstract as we don't actually pass in the state when using the getter methods. In anycase, it refers to the current data state of the module.
