...
* List some of the 10 heuristics in a presentation.
* Recognise real world examples of the 10 heurristics in digital products.
* Critique real world examples of the 10 heurristics in digital products, by identifying particular characteristics of good execution. 
...
![you are here map](https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/You_are_here_map.jpg/900px-You_are_here_map.jpg "https://commons.wikimedia.org/wiki/User:PaulSyms22")
...
1. __Date selection on a calendar__: Offer good defaults and set boundaries when people book services by dates. Grey out unavailable options.
...
1. __Lisbon__: People are more likely to correctly answer the question "Is Lisbon the capital of Portugal?" rather than "What’s the capital of Portugal?". The Russian game _What_, _who_, _how_ bakes the correct anwsers into the question.
...
<small>Nielsen, J. (1994a). Enhancing the explanatory power of usability heuristics. Proc. ACM CHI'94 Conf. (Boston, MA, April 24-28), 152-158. [nngroup.com/articles/ten-usability-heuristics](nngroup.com/articles/ten-usability-heuristics)</small>